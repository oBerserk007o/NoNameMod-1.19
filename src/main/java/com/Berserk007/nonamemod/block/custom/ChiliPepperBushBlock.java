...
public class ChiliPepperBushBlock extends SweetBerryBushBlock {
    public ChiliPepperBushBlock(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult use(BlockState pState, Level pLevel, BlockPos pPos, Player pPlayer, InteractionHand pHand, BlockHitResult pHit) {
        ...
        if (!flag && pPlayer.getItemInHand(pHand).is(Items.BONE_MEAL)) {
            ...
            popResource(pLevel, pPos, new ItemStack(ModItems.CHILI_PEPPER.get(), j + (flag ? 1 : 0)));
